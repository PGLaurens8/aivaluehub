...
export default function ValueMatrix() {
    ...
    return (
        <section id="value-matrix" className="py-16 lg:py-20 bg-background">
                ...
                <div className="mt-12 min-h-[200px]">
                    {caseStudies.length > 0 ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in-50 duration-500">
                            {caseStudies.map(cs => (
                                <Card key={cs.company} className="flex flex-col bg-card border-primary/20 shadow-lg hover:shadow-xl hover:shadow-primary/30 transition-shadow duration-300">
                                    <CardHeader>
